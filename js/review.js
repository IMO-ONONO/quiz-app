const SUBJECTS = [
  { id: 'animals', label: '動物の生態', file: 'data/animals.json', categoryGroup: true },
  { id: 'paleontology', label: '古生物', file: 'data/paleontology.json', categoryGroup: true },
  { id: 'cs', label: 'コンピュータサイエンス', file: 'data/cs.json', categoryGroup: true },
  { id: 'art', label: '美術', file: 'data/art.json', categoryGroup: true },
];
